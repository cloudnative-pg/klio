...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackup":       schema_core_internal_k8sapi_v1alpha1_KlioBackup(ref),
		"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackupList":   schema_core_internal_k8sapi_v1alpha1_KlioBackupList(ref),
		"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackupSpec":   schema_core_internal_k8sapi_v1alpha1_KlioBackupSpec(ref),
		"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackupStatus": schema_core_internal_k8sapi_v1alpha1_KlioBackupStatus(ref),
		"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.TablespaceLayout": schema_core_internal_k8sapi_v1alpha1_TablespaceLayout(ref),
...
func schema_core_internal_k8sapi_v1alpha1_KlioBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackupSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackupStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackupSpec", "github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackupStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_core_internal_k8sapi_v1alpha1_KlioBackupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.KlioBackup", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_core_internal_k8sapi_v1alpha1_KlioBackupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"clusterName": {
						SchemaProps: spec.SchemaProps{
							Description: "ClusterName is the name of the cluster that has been backed up",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"backupID": {
						SchemaProps: spec.SchemaProps{
							Description: "BackupID is the unique identifier of the backup",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"clusterName", "backupID"},
			},
		},
	}
}

func schema_core_internal_k8sapi_v1alpha1_KlioBackupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"startLSN": {
						SchemaProps: spec.SchemaProps{
							Description: "StartLSN is the LSN of the backup start",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"endLSN": {
						SchemaProps: spec.SchemaProps{
							Description: "EndLSN is the LSN of the backup end",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"startWAL": {
						SchemaProps: spec.SchemaProps{
							Description: "StartWAL is the current WAL when the backup started",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"endWAL": {
						SchemaProps: spec.SchemaProps{
							Description: "EndWAL is the current WAL when the backup ends",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"tablespaces": {
						SchemaProps: spec.SchemaProps{
							Description: "Tablespaces are the metadata of the tablespaces",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.TablespaceLayout"),
									},
								},
							},
						},
					...
					"annotations": {
						SchemaProps: spec.SchemaProps{
							Description: "Annotations is a generic data store where each backend can put its metadata.",
							Type:        []string{"object"},
					...
					"startedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "StartedAt is the current time when the backup started.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
					"stoppedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "StoppedAt is the current time when the backup ended.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
				},
				Required: []string{"startLSN", "endLSN", "startWAL", "endWAL", "startedAt", "stoppedAt"},
			},
		},
		Dependencies: []string{
			"github.com/cloudnative-pg/klio/core/internal/k8sapi/v1alpha1.TablespaceLayout", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}

func schema_core_internal_k8sapi_v1alpha1_TablespaceLayout(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TablespaceLayout is the on-disk structure of a tablespace.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the tablespace name",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"oid": {
						SchemaProps: spec.SchemaProps{
							Description: "Oid is the OID of the tablespace.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"path": {
						SchemaProps: spec.SchemaProps{
							Description: "Path is the path where the tablespace can be found.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"annotations": {
						SchemaProps: spec.SchemaProps{
							Description: "Annotations is a generic data store where each backend can annotate its metadata.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
				...
				Required: []string{"name", "oid", "path", "annotations"},
			},
		},
	}
}
