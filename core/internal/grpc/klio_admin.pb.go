...
type QueueRetryBackupsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClusterName   *string                `protobuf:"bytes,1,opt,name=cluster_name,json=clusterName,proto3,oneof" json:"cluster_name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *QueueRetryBackupsRequest) Reset() {
	*x = QueueRetryBackupsRequest{}
	mi := &file_proto_klio_admin_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QueueRetryBackupsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueueRetryBackupsRequest) ProtoMessage() {}

func (x *QueueRetryBackupsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_klio_admin_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueueRetryBackupsRequest.ProtoReflect.Descriptor instead.
func (*QueueRetryBackupsRequest) Descriptor() ([]byte, []int) {
	return file_proto_klio_admin_proto_rawDescGZIP(), []int{11}
}

func (x *QueueRetryBackupsRequest) GetClusterName() string {
	if x != nil && x.ClusterName != nil {
		return *x.ClusterName
	}
	return ""
