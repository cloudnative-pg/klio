...
require (
	...
	go.opentelemetry.io/contrib/bridges/prometheus v0.66.0
	go.opentelemetry.io/contrib/detectors/autodetect v0.13.0
...
require (
	...
	go.opentelemetry.io/contrib/detectors/aws/ec2/v2 v2.3.0 // indirect
	go.opentelemetry.io/contrib/detectors/aws/ecs v1.41.0 // indirect
	go.opentelemetry.io/contrib/detectors/aws/eks v1.41.0 // indirect
	go.opentelemetry.io/contrib/detectors/aws/lambda v0.66.0 // indirect
	go.opentelemetry.io/contrib/detectors/azure/azurevm v0.13.0 // indirect
