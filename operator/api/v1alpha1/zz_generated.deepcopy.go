...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompressionPolicy) DeepCopyInto(out *CompressionPolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompressionPolicy.
func (in *CompressionPolicy) DeepCopy() *CompressionPolicy {
	if in == nil {
		return nil
	}
...
func (in *FileSource) DeepCopyInto(out *FileSource) {
	*out = *in
	if in.FileReference != nil {
		in, out := &in.FileReference, &out.FileReference
		*out = new(FileReference)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *Tier1Configuration) DeepCopyInto(out *Tier1Configuration) {
	*out = *in
	...
	in.EncryptionKeyFile.DeepCopyInto(&out.EncryptionKeyFile)
	in.IdentityFile.DeepCopyInto(&out.IdentityFile)
