	...
	tests := []struct {
		...
		},
		{
			...
			assertions: func(t *testing.T, cfg *config.Data) {
				...
				assert.Equal(t, new(int32(5)), cfg.Tier1RetentionPolicy.Latest)
			},
		},
		{
			...
			assertions: func(t *testing.T, cfg *config.Data) {
				...
				assert.Equal(t, new(int32(4)), cfg.Tier2RetentionPolicy.Latest)
			},
		},
		{
			...
			assertions: func(t *testing.T, cfg *config.Data) {
				...
				assert.NotNil(t, cfg.Tier1RetentionPolicy)
				assert.NotNil(t, cfg.Tier2RetentionPolicy)
				assert.Equal(t, new(int32(3)), cfg.Tier1RetentionPolicy.Latest)
				assert.Equal(t, new(int32(10)), cfg.Tier2RetentionPolicy.Latest)
			},
		},
		{
...
func TestConvertTier1RetentionPolicy(t *testing.T) {
	...
	t.Run("tier1 with retention policy", func(t *testing.T) {
		...
		assert.NotNil(t, result)
		assert.Equal(t, new(int32(10)), result.Latest)
	})
}
...
func TestConvertTier2RetentionPolicy(t *testing.T) {
	...
	t.Run("tier2 with retention policy", func(t *testing.T) {
		...
		assert.NotNil(t, result)
		assert.Equal(t, new(int32(7)), result.Latest)
	})
}
