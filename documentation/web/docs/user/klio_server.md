...
spec:
  ...
  image: ghcr.io/enterprisedb/klio:v0.0.13
...
1. **Temporary misalignment**: After the PVC patch, there is a brief period
...
1. **Pod restart**: The Klio server pod restarts and mounts the already-expanded
   PVCs.
