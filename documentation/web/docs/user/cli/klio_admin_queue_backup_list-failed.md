---
title: klio admin queue backup list-failed
---

## klio admin queue backup list-failed

List failed backup tasks in the queue

```
klio admin queue backup list-failed [flags]
```

### Options

```
      --cluster-name string   Cluster name to filter failed backup tasks (optional)
  -h, --help                  help for list-failed
```
