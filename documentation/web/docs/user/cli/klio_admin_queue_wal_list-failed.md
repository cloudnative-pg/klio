---
title: klio admin queue wal list-failed
---

## klio admin queue wal list-failed

List failed WAL tasks in the queue

```
klio admin queue wal list-failed [flags]
```

### Options

```
      --cluster-name string   Cluster name to filter failed WAL tasks (optional)
