...
registering a new API group `kliocatalog.cnpg.io/v1alpha1` that provides
...
See the [Klio documentation](./klio_server.md#creating-a-client-side-certificate)
...
kind: APIService
metadata:
  name: v1alpha1.kliocatalog.cnpg.io
...
```yaml
apiVersion: kliocatalog.cnpg.io/v1alpha1
kind: KlioBackup
metadata:
...
An API service it tied to a specific Klio server instance. If you have multiple
