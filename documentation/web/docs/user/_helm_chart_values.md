...
| controllerManager.manager.env | object | `{"SIDECAR_IMAGE":"ghcr.io/enterprisedb/klio:v0.0.9"}` | The environment variables to set in the controller manager container. |
...
| controllerManager.manager.image.tag | string | `"v0.0.9"` | The tag to use for the controller manager container image. |
