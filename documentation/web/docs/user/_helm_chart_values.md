...
| controllerManager.manager.env | object | `{"SIDECAR_IMAGE":"ghcr.io/enterprisedb/klio:v0.0.12"}` | The environment variables to set in the controller manager container. |
